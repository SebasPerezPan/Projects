...
def folder_creation_competition(competition_id):
    ruta_carpeta = f'/home/sp3767/Practice/Python/Projects/Apuestas/data/{competition_id}' 
    os.makedirs(ruta_carpeta, exist_ok=True)  # Crea la carpeta si no existe

def folder_creation_season(competition_id, season_name):
    ruta_carpeta = f'/home/sp3767/Practice/Python/Projects/Apuestas/data/{competition_id}/{season_name}/jornadas'
    os.makedirs(ruta_carpeta, exist_ok=True)  # Crea la carpeta si no existe
    ruta_carpeta = f'/home/sp3767/Practice/Python/Projects/Apuestas/data/{competition_id}/{season_name}/match_data'
    os.makedirs(ruta_carpeta, exist_ok=True)  # Crea la carpeta si no existe
